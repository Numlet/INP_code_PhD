...
cube_GP_HAM_DMDUST= iris.load(ukl.Obtain_name(sim_path+'/GP_HAM_DMDUST/All_time_steps/','m01s01i208'))[0]
...
stc.plot_map(runs_dict,levels,lat=X,lon=Y,variable_name='(SC) TOA shortwave (CCN) Wm-2')
stc.plot_PDF(runs_dict,levels_bin,variable_name='(SC) TOA shortwave (CCN) Wm-2')
