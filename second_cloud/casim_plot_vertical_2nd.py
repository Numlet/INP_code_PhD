...
temperature=iris.load(ukl.Obtain_name('/nfs/a201/eejvt/CASIM/SECOND_CLOUD/GP_HAM_DMDUST/L1/','Temp'))[0]
...
with writer.saving(fig,'/nfs/a201/eejvt/SO_VIDEOS_2/Triple_plot_01116_'+lin_log+'_'+sample_cube.var_name+'_'+names+".mp4", 200):
