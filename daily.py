...
def calculate_INP_feld_ext(T):
    ...
    return INP
INP_feld_ext=np.zeros((38, 31, 64, 128, 365))
for t in range(38):
    print t
    INP_feld_ext[t,:,:,:,:]=calculate_INP_feld_ext_mean_area_fitted(-t+273.15).sum(axis=0)

np.save('INP_feld_ext_daily_alltemps',INP_feld_ext)